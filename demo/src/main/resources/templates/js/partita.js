...
var cardGiocatore = ["fante", "fante", "fante"];
...
$('#gameInfo').append('<br><img src="assets/img/giocatore1-avatar.svg" width="40px" height="40px"/><p style="color:#99c2ff"><b>Stati giocatore:<b></p>')
...
$('#gameInfo').append('<br><img src="assets/img/ai-avatar.svg" width="40px" height="40px"/><p style="color:#ff6666"><b>Stati AI'+obj+': <b></p>')
...
function controlloAttacco(armate, armateAttuali){
	...
	if(armateAttuali < armate){
		if(armateAttuali > 2)armate = armateAttuali;
		else
		checkAttacco = true;
	}else{
		faseAttacco = false;
...
function concludiTurno(){
    ...
    if(turnoGiocatore == true){
      ...
      for(var obj in players_AI){
        ...
        players_AI[obj].assegnazioneRandomInizioTurno();
    ...
    document.getElementById('pescaCard').style.display = 'none';
